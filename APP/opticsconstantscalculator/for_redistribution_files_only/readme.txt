optics_propertions_calculator Executable
...
================================
-run_optics_propertions_calculator.sh (shell script for temporarily setting environment 
                                       variables and executing the application)
   -to run the shell script, type
   
       ./run_optics_propertions_calculator.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2023a, run the shell script as:
       ...
       ./run_optics_propertions_calculator.sh /mathworks/home/application/R2023a
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_optics_propertions_calculator.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure optics_propertions_calculator.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r optics_propertions_calculator.zip optics_propertions_calculator.app
    or the tar command 
    tar -cvf optics_propertions_calculator.tar optics_propertions_calculator.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/R2023a/runtime/maci64:MR/R2023a/sys/os/maci64:MR/R2023a/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_optics_propertions_calculator.sh 
